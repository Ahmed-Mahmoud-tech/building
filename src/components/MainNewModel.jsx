...
const Main = () => {
  ...
  const [infoDesc, setInfoDesc] = useState(
    'Lorem ipsum dolor sit amet consectetur adipisicing elit. Nam explicabo doloremque reiciendis voluptas tenetur. Earum inventore architecto iusto, dolores similique, quas ex expedita fuga eum ratione molestiae voluptas reiciendis id?'
  )
        ...
        <Wrapper feetColor={moveType == 'stop' ? '#ddd' : 'orange'}>
          ...
          <a-scene cursor="rayOrigin: mouse">
            ...
            <a-entity
              ...
              gltf-model="url(/assets/3dModel/the_big_bang_theory_virtual_apartment/scene.gltf)"
              cursor-listener
              rotation="0 0 0"
              scale="5 5 5"
              position="-80 0 50"
