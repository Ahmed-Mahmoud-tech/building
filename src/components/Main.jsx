    ...
    <>
      ...
      {loaded ? <Wrapper feetColor={ moveType == "stop" ? "#ddd" : "orange"}>
        ...
        <a-scene cursor="rayOrigin: mouse">
          ...
          <a-entity shadow="receive: false; cast:true" gltf-model="url(/assets/3dModel/the_big_bang_theory_virtual_apartment/scene.gltf)" cursor-listener rotation="0 0 0" scale="5 5 5"  ></a-entity>
